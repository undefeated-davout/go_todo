...
import (
	...
	"github.com/undefeated-davout/go_todo/clock"
	...
	"github.com/undefeated-davout/go_todo/testutil/fixture"
)
...
func TestJWTer(t *testing.T) {
	...
	req := httptest.NewRequest(
		http.MethodGet,
		`https://github.com/undefeated-davout`,
		nil)
...
func TestJWTer_GetJWT(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/undefeated-davout/go_todo`).
